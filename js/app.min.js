...
let newsMiniSlider = new Swiper('.slider-news-mini__body');
if (document.querySelector('.slider-news-mini__body')) {
	new Swiper('.slider-news-mini__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 3.3,
		direction: 'vertical',
...
// let newsSlider = new Swiper('.slider-news__body');
if (document.querySelector('.slider-news__body')) {
	new Swiper('.slider-news__body', {
		...
		// Dotts
		pagination: {
			el: '.slider-news__dotts',
			clickable: true,
		},
		// Scroll
		scrollbar: {
			el: '.slider-news .slider-news__scrollbar',
			draggable: true,
		},
		thumbs: {
			swiper: newsMiniSlider,
		},

	});
}
// let pageSlider = new Swiper('.slider-page__body');
if (document.querySelector('.slider-page__body')) {
	new Swiper('.slider-page__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		watchOverflow: true,
...
// newsSlider.controller.control = newsMiniSlider;
// newsMiniSlider.controller.control = newsSlider;
